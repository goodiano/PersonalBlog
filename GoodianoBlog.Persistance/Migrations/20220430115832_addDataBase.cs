    ...
    public partial class addDataBase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "InsertTime", "IsRemoved", "RemoveTime", "RoleName", "UpdateTime" },
                values: new object[] { 1, new DateTime(2022, 4, 30, 16, 28, 31, 967, DateTimeKind.Local).AddTicks(5872), false, null, "Admin", null });

            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "InsertTime", "IsRemoved", "RemoveTime", "RoleName", "UpdateTime" },
                values: new object[] { 2, new DateTime(2022, 4, 30, 16, 28, 31, 967, DateTimeKind.Local).AddTicks(5947), false, null, "Customer", null });
