...
namespace GoodianoBlog.Persistance.Migrations
{
    ...
    [Migration("20220719153612_AddReplayCommentEntityAndEditCommentEntity")]
    partial class AddReplayCommentEntityAndEditCommentEntity
    {
            ...
            modelBuilder.Entity("GoodianoBlog.Domain.Entities.Posts.CommentReplay", b =>
                {
                    ...
                    b.HasOne("GoodianoBlog.Domain.Entities.Posts.Post", null)
                        .WithMany("CommentReplays")
                        .HasForeignKey("PostId");
