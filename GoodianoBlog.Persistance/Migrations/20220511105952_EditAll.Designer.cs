...
namespace GoodianoBlog.Persistance.Migrations
{
    ...
    [Migration("20220511105952_EditAll")]
            ...
            modelBuilder.Entity("GoodianoBlog.Domain.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            InsertTime = new DateTime(2022, 5, 11, 15, 29, 52, 550, DateTimeKind.Local).AddTicks(8178),
                            IsRemoved = false,
                            RoleName = "Admin"
                        },
                        new
                        {
                            Id = 2,
                            InsertTime = new DateTime(2022, 5, 11, 15, 29, 52, 550, DateTimeKind.Local).AddTicks(8253),
                            IsRemoved = false,
                            RoleName = "Customer"
                        });
                });
