...
namespace GoodianoBlog.Persistance.Migrations
{
    ...
    [Migration("20220507074527_EditUserEntity")]
            ...
            modelBuilder.Entity("GoodianoBlog.Domain.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            InsertTime = new DateTime(2022, 5, 7, 12, 15, 27, 660, DateTimeKind.Local).AddTicks(6446),
                            IsRemoved = false,
                            RoleName = "Admin"
                        },
                        new
                        {
                            Id = 2,
                            InsertTime = new DateTime(2022, 5, 7, 12, 15, 27, 660, DateTimeKind.Local).AddTicks(6517),
                            IsRemoved = false,
                            RoleName = "Customer"
                        });
                });
